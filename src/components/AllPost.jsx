...
export const AllPost = () => {
    return (
        <div
            className="bg-gray-100 font-pop"
            style={{
                // backgroundImage: "url('./../assets/11.png')",
                backgroundImage:
                    "url('https://res.cloudinary.com/be-chef/image/upload/v1672792193/ds4fsmo4ivw6a7ddwl7j.jpg')",
            }}
        >
                            ...
                            <div className="px-6 py-4">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Incluye 2 entradas, 1 plato principal y
                                        1 postre.
                                    </p>
                                </div>
                                <div className="mt-4">
